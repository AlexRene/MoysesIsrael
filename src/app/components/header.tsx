...
export default function Header(){
    return(
        ...
        <div className="flex item-center justify-center max-sm:hidden">
          ...
          <Link href='/contato' className="px-5 text-slate-800 hover:text-slate-400 hover:underline self-center">Contato</Link>
          <Link href='/podcast' ><button className="border-yellow-500 border-2 text-zinc-900 px-5 py-1.5 rounded-md hover:text-zinc-50 hover:bg-yellow-500 transition-all ease-in-out duration-300">Podcast</button></Link>
        </div>
      </header>
    )
}